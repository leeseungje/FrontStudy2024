...
const NavItem = ({
  ...
  const isActive =
    segment &&
    (Array.isArray(matchSegment)
      ? matchSegment.includes(segment)
  ...
  return (
    <>
      {navItems.map((item, index) => (
        <NavItem key={index} {...item} segment={segment} />
      ))}
    </>
  )
}
